...
#     def process(self, text: str) -> Optional[CaseRecord]:
...
#             case_category = None,
#             date=date_time,
#             detail=extracted_data["grievance"] or "",
#             location=extracted_data["location"] or "",
#             priority = None,
#             score = None,
#             status = "OPEN",
#             caller=extracted_data["name"] or "",
#             phone_no=extracted_data["number"] or "",
#             sub_reddit_id = None)
...
#         combined_text = f"{grievance.caller} {grievance.phone_no} {grievance.detail} {grievance.location}"
#         print(combined_text)
#         is_spam, spam_reason = self.detect_spam(
#             combined_text, grievance.phone_no
#         )
#         # print(spam_reason)
